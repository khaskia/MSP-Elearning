...
public final class addnews_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<h1 class=\"page-header\">Add News</h1>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div><!--/.row-->\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"panel-heading\">News Form</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control\" placeholder=\"Placeholder\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                                                                <div class=\"form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label>Choose a photo</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"file\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t <p class=\"help-block\"></p>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label>The Content</label>\r\n");
