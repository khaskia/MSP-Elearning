...
public final class tables_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<table data-toggle=\"table\" data-url=\"tables/data1.json\"  data-show-refresh=\"true\" data-show-toggle=\"true\" data-show-columns=\"true\" data-search=\"true\" data-select-item-name=\"toolbar1\" data-pagination=\"true\" data-sort-name=\"name\" data-sort-order=\"desc\">\r\n");
      out.write("\t\t\t\t\t\t    <thead>\r\n");
      out.write("\t\t\t\t\t\t    <tr>\r\n");
      out.write("\t\t\t\t\t\t        <th data-field=\"state\" data-checkbox=\"true\" >Item ID</th>\r\n");
      out.write("\t\t\t\t\t\t        <th data-field=\"id\" data-sortable=\"true\">Item ID</th>\r\n");
      out.write("\t\t\t\t\t\t        <th data-field=\"name\"  data-sortable=\"true\">Item Name</th>\r\n");
      out.write("\t\t\t\t\t\t        <th data-field=\"price\" data-sortable=\"true\">Item Price</th>\r\n");
      out.write("\t\t\t\t\t\t    </tr>\r\n");
      out.write("\t\t\t\t\t\t    </thead>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<div class=\"panel panel-default\">\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading\">Basic Table</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-body\">\r\n");
      out.write("\t\t\t\t\t\t<table data-toggle=\"table\" data-url=\"tables/data2.json\" >\r\n");
      out.write("\t\t\t\t\t\t    <thead>\r\n");
      out.write("\t\t\t\t\t\t    <tr>\r\n");
      ...
      out.write("\t\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t\t<div class=\"panel panel-default\">\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading\">Styled Table</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-body\">\r\n");
      out.write("\t\t\t\t\t\t<table data-toggle=\"table\" id=\"table-style\" data-url=\"tables/data2.json\" data-row-style=\"rowStyle\">\r\n");
      out.write("\t\t\t\t\t\t    <thead>\r\n");
      out.write("\t\t\t\t\t\t    <tr>\r\n");
      out.write("\t\t\t\t\t\t        <th data-field=\"id\" data-align=\"right\" >Item ID</th>\r\n");
      out.write("\t\t\t\t\t\t        <th data-field=\"name\" >Item Name</th>\r\n");
      ...
      out.write("\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t    $(function () {\r\n");
      out.write("\t\t\t\t\t\t        $('#hover, #striped, #condensed').click(function () {\r\n");
      out.write("\t\t\t\t\t\t            var classes = 'table';\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t            if ($('#hover').prop('checked')) {\r\n");
      out.write("\t\t\t\t\t\t                classes += ' table-hover';\r\n");
      out.write("\t\t\t\t\t\t            }\r\n");
      out.write("\t\t\t\t\t\t            if ($('#condensed').prop('checked')) {\r\n");
      out.write("\t\t\t\t\t\t                classes += ' table-condensed';\r\n");
      out.write("\t\t\t\t\t\t            }\r\n");
      out.write("\t\t\t\t\t\t            $('#table-style').bootstrapTable('destroy')\r\n");
      out.write("\t\t\t\t\t\t                .bootstrapTable({\r\n");
      out.write("\t\t\t\t\t\t                    classes: classes,\r\n");
      out.write("\t\t\t\t\t\t                    striped: $('#striped').prop('checked')\r\n");
      out.write("\t\t\t\t\t\t                });\r\n");
      out.write("\t\t\t\t\t\t        });\r\n");
      out.write("\t\t\t\t\t\t    });\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t    function rowStyle(row, index) {\r\n");
      out.write("\t\t\t\t\t\t        var classes = ['active', 'success', 'info', 'warning', 'danger'];\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t        if (index % 2 === 0 && index / 2 < classes.length) {\r\n");
      out.write("\t\t\t\t\t\t            return {\r\n");
      out.write("\t\t\t\t\t\t                classes: classes[index / 2]\r\n");
      out.write("\t\t\t\t\t\t            };\r\n");
      out.write("\t\t\t\t\t\t        }\r\n");
      out.write("\t\t\t\t\t\t        return {};\r\n");
      out.write("\t\t\t\t\t\t    }\r\n");
